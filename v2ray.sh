...
rm geosite.dat 
rm geoip.dat
wget https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geosite.dat > /dev/null 2>&1
wget https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geoip.dat > /dev/null 2>&1
wget https://github.com/SamadiPour/iran-hosted-domains/releases/latest/download/iran.dat > /dev/null 2>&1
mv geosite.dat geoip.dat iran.dat /usr/local/share/v2ray/
